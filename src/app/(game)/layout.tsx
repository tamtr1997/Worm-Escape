  ...
  return (
    <div className="h-dvh w-full bg-zinc-700 p-2">
      ...
      <div className="grid h-full w-full place-items-center">
        ...
        <main className="relative aspect-[9/16] h-full max-h-full w-full max-w-full overflow-hidden bg-slate-900 shadow-2xl sm:rounded-2xl sm:border-8 sm:border-black">
